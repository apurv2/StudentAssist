...
public class NotificationSettingsActivity extends AppCompatActivity implements LodingDialogInterface {
    ...
    private void unCheckboxes(ViewGroup mViewGroup) {
    ...
    private void setCheckboxes(NotificationSettings settings) {
        ...
        CheckBox mOnCampusCheckbox = (CheckBox) findViewById(R.id.onCampusCheckbox);
        CheckBox mOffCampusCheckbox = (CheckBox) findViewById(R.id.offCampusCheckbox);
        CheckBox mDormsCheckbox = (CheckBox) findViewById(R.id.dormsCheckbox);
    ...
    private void subscribeNotifications() {
        try {
            ...
            if (validate()) {
                ...
                manager.volleyPostRequestWithLoadingDialog(urlgen.getInsertNotificationsUrl(), loadingDialog, postParams);
            }
