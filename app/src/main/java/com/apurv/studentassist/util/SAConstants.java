...
public class SAConstants {
    ...
    //public static final String URL = "http://awsenv.czbki664xm.us-west-2.elasticbeanstalk.com";
    ...
    public static final String UNIVERSITIES_LIST = "universities_list";

    public static final String UNIVERSITIES_IN_DB = "universities_in_db";

    // Graph User Json Feed
    ...
    // SERVER JSON FEED PARSE CONSTANTS
    ...
    public static final String SETTING_THINGS_UP = "Setting things up...";
    ...
    public static final String GROUP_NAME = "serviceName";
    ...
    public static final String DELETING_POST = "Deleting Your Post";
    ...
    public static final String DOESNT_MATTER = "Doesnt Matter";

    public static final String NEED_PERMISSION = "Need Phone State permission to send notifications to your device";

    public static final String DORMS = "dorms";

    public static final String USER_VISITED_SW = "userVisitedSw";
